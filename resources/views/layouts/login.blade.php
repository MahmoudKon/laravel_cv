...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        ...
        rel="stylesheet">
        <link href="https://maxcdn.ico') }}ns8.com/fonts/line-awesome/1.1/css/line-awesome.min.css"
        rel="stylesheet">
        <!-- BEGIN VENDOR CSS-->
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/css/core/menu/menu-types/vertical-compact-menu.css') }}">
    ...
    data-open="click" data-menu="vertical-compact-menu" data-col="1-column">
        ...
        <!-- END PAGE LEVEL JS-->
        <!-- Cod JS To Preview The Image When Selected -->
        <script>
