    ...
    <div class="col-md-4">
        <div class="form-group has-feedback">
            ...
            <div class="input-group">
                ...
                <select class="custom-select" name="user_id" {{ isset($experience->user_id) ? 'disabled' : ''  }}>
                            ...
                            <optgroup label="Select a User Name">
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}"
                                            {{ isset($experience->user_id) ? ($experience->user_id == $user->id ? 'selected' : '') : (old('user_id') == $user->id ? 'selected' : '') }}>
                                        {{ $user->username }}
                                    </option>
                                @endforeach
                            </optgroup>
    ...
    <div class="col-md-4">
        <div class="form-group has-feedback">
            ...
            <div class="input-group">
                ...
                <input type="date" id="minYear"  name="start_date" class="form-control" placeholder="Select Start Date"
                        value="{{ isset($experience->start_date) ? $experience->start_date : old('start_date') }}" required>
            </div>
    ...
    <div class="col-md-4">
        <div class="form-group has-feedback">
            ...
            <div class="input-group">
                ...
                <input type="date" id="maxYear" name="end_date" class="form-control" placeholder="Select End Date"
                        value="{{ isset($experience->end_date) ? $experience->end_date : old('end_date') }}" required>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="degree" class="form-control" placeholder="Your Degree"
                        value="{{ isset($experience->degree) ? $experience->degree : old('degree') }}" required>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="place" class="form-control" placeholder="Your Place"
                        value="{{ isset($experience->place) ? $experience->place : old('place') }}" required>
            </div>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            <textarea id="ckeditor-language" class="ckeditor-language ckeditor" name="description"
                ...
                {{ isset($experience->description) ? $experience->description : old('description') }}
            </textarea>
        </div>
